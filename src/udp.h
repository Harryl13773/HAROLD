...
// Captures the next datagram on local_port while net_task handles the NIC
void udp_arm_response_capture(uint16_t local_port);

// Waits for the captured datagram; returns its length or -1 on timeout, then disarms
