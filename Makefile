...
userspace/nslookup.elf: userspace/nslookup.c userspace/libc.c userspace/libc.h userspace/linker.ld
	...
	$(CC) $(USERCFLAGS) -c userspace/libc.c -o userspace/libc.o
	$(LD) -m elf_i386 -T userspace/linker.ld userspace/nslookup.o userspace/libc.o -o userspace/nslookup.elf

# Prints the current date/time via rtc_read() — proves the RTC driver end-to-end
userspace/date.elf: userspace/date.c userspace/libc.c userspace/libc.h userspace/linker.ld
	$(CC) $(USERCFLAGS) -c userspace/date.c -o userspace/date.o
	$(CC) $(USERCFLAGS) -c userspace/libc.c -o userspace/libc.o
...
# A basic ed-style line editor — the first real way to create/edit multi-line text content
userspace/edit.elf: userspace/edit.c userspace/libc.c userspace/libc.h userspace/linker.ld
	$(CC) $(USERCFLAGS) -c userspace/edit.c -o userspace/edit.o
	$(CC) $(USERCFLAGS) -c userspace/libc.c -o userspace/libc.o
